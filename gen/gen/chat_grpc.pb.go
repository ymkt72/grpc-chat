...
const (
	ChatService_Chat_FullMethodName = "/grpcchat.ChatService/Chat"
)
...
//
// クライアントからメッセージを受け取り、サーバーからメッセージを返す
type ChatServiceClient interface {
	// クライアントからメッセージを受け取りメッセージを返すrpc
	Chat(ctx context.Context, in *ClientMessage, opts ...grpc.CallOption) (*ServerMessage, error)
}
...
func (c *chatServiceClient) Chat(ctx context.Context, in *ClientMessage, opts ...grpc.CallOption) (*ServerMessage, error) {
...
type ChatServiceServer interface {
	// クライアントからメッセージを受け取りメッセージを返すrpc
	Chat(context.Context, *ClientMessage) (*ServerMessage, error)
...
func (UnimplementedChatServiceServer) Chat(context.Context, *ClientMessage) (*ServerMessage, error) {
...
func _ChatService_Chat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).Chat(ctx, req.(*ClientMessage))
	}
